    ...
    <main className="mx-auto flex min-h-screen max-w-6xl flex-col gap-8 px-6 py-10">
      <header className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
        <div className="flex flex-col gap-2">
          ...
          <p className="max-w-4xl text-base leading-relaxed text-slate-600 text-pretty">
            ...
            problems. Chat to learn core concepts and get theoretical guidance for your projects.
          </p>
        </div>
      </header>

      <div className="flex flex-col gap-4">
        <div className="h-[65vh] rounded-3xl border border-slate-200 bg-white/80 p-6 shadow-inner backdrop-blur">
